...
Description : Tests for the Common functions and type classes
Copyright   : (c) Andrew Burnett 2014-2015
Maintainer  : andyburnett88@gmail.com
Stability   : experimental
Portability : Unknown

The test node for the Common module
-}
...
genBounds   :: (Bounded a, Ord a) => Gen a -> Gen (Bounds a)
genBounds f =
  oneof [
    return mkNoBounds,
    mkMinimum <$> f,
...
mkPosDoubleTest2 =
  testCase "mkPosDouble negative value throws run time error" $
